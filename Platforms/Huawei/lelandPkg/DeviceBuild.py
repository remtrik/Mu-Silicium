...
class CommonPlatform ():
    PackagesSupported = ("lelandPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('leland', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "leland", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "lelandPkg/leland.dsc", "Platform Hardcoded")
